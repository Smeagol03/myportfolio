      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-20 mb-20">
          ...
          <div className="md:col-span-12 lg:col-span-5 space-y-8">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-2xl bg-linear-to-br from-cyan-500 to-blue-600 flex items-center justify-center shadow-lg shadow-cyan-500/20">
                <span className="text-white font-bold text-2xl font-outfit">A</span>
              </div>
              <div className="flex flex-col leading-none">
                <span className="text-xl font-black font-outfit tracking-wider text-white">ALPIAN TABRANI</span>
                <span className="text-[10px] uppercase tracking-[0.4em] font-bold text-cyan-400 mt-1">Digital Solution Expert</span>
              </div>
            </div>
            
            <p className="text-slate-400 font-light leading-relaxed max-w-md text-lg">
              Membangun efisiensi melalui solusi digital kreatif. Berfokus pada manajemen data dan pengembangan web modern.
            </p>
          ...
          <div className="md:col-span-6 lg:col-span-3">
            <h3 className="text-white font-bold font-outfit uppercase tracking-widest text-sm mb-8">Navigation</h3>
            <ul className="grid grid-cols-2 gap-y-4 gap-x-8">
              {["Home", "About", "Pendidikan", "Skills", "Projects", "Experience", "Contact"].map((item) => (
                <li key={item}>
                  <a 
          ...
          <div className="md:col-span-6 lg:col-span-4">
            <h3 className="text-white font-bold font-outfit uppercase tracking-widest text-sm mb-8">Quick Connect</h3>
            <div className="space-y-6">
              <a href="mailto:atabrani3@gmail.com" className="flex items-center gap-4 group">
                ...
                <span className="text-slate-400 font-light text-sm group-hover:text-white transition-colors">atabrani3@gmail.com</span>
              </a>
              <div className="flex items-center gap-4 group cursor-default">
                <div className="w-10 h-10 rounded-xl bg-white/5 border border-white/5 flex items-center justify-center">
                  <MapPin className="w-4 h-4 text-slate-400" />
                </div>
                <span className="text-slate-400 font-light text-sm">Lombok Timur, NTB - ID</span>
              </div>
            </div>
          </div>
        </div>
