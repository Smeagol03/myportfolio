...
const Experience = () => {
  return (
    <section
      id="experience"
      className="py-24 bg-[var(--bg-secondary)] border-t border-[var(--border-color)] relative transition-colors duration-500"
    >
        ...
        <div className="space-y-6">
          {experienceData.map((exp, index) => (
            <motion.div
              ...
              className="group relative p-6 sm:p-8 rounded-2xl flex flex-col md:flex-row gap-6 sm:gap-8 items-start border-[var(--border-color)] bg-[var(--bg-primary)] hover:shadow-xl hover:border-blue-200 dark:hover:border-zinc-700 transition-all"
            >
