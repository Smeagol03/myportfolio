...
const educationData = [
  {
    ...
    description:
      "Deepening expertise in public administration, organizational logic, and management systems.",
  ...
  },
  {
    ...
    status: "GRADUATED",
    description:
      "Foundation of digital production, visual hierarchy, and multimedia systems.",
    icon: School,
    color: "purple",
  },
  {
    ...
    status: "COMPLETED",
    description:
      "Developing core analytical skills and fundamental academic systems.",
    icon: BookOpen,
    color: "zinc",
  },
  {
    ...
    status: "COMPLETED",
    description:
      "Initial academic registration and foundational learning modules.",
    icon: Library,
    color: "zinc",
  },
];
        ...
        <div className="glass-2 p-8 md:p-12 rounded-2xl bg-white/5 border-t border-white/10 hover:border-blue-500/30 transition-all duration-700 relative overflow-hidden">
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-10">
            <div>
              ...
              <h3 className="text-lg md:text-5xl font-black font-outfit text-(--text-primary) uppercase tracking-tighter mb-2 group-hover:text-blue-500 transition-colors">
                {item.level}
              </h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
            ...
            {item.achievements && (
              <div className="lg:col-span-4 flex flex-col gap-3">
                <span className="text-[8px] font-black text-(--text-muted) uppercase tracking-[0.4em] mb-2 block">
                  Credentials Issued
                </span>
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none opacity-[0.02] select-none flex flex-col justify-center items-center">
        <div className="text-[25rem] font-black uppercase leading-none">
          ARCHIVE
        </div>
        <div className="text-[25rem] font-black uppercase leading-none -mt-20">
          SYSTEM
        </div>
      </div>
      ...
      <div className="container mx-auto px-6 max-w-6xl relative z-10">
          ...
          <div className="flex flex-col md:flex-row justify-start md:justify-between items-start md:items-end gap-12">
            <div className="max-w-2xl">
              ...
              <FadeIn delay={0.2} direction="up">
                <h2 className="text-5xl md:text-9xl font-outfit font-bold tracking-tighter text-(--text-primary) uppercase leading-[0.85] mb-8">
                  Academic <br />
            ...
            <FadeIn
              delay={0.4}
              direction="up"
              className="hidden lg:flex items-center gap-6 p-6 glass-2 rounded-2xl border-l-4 border-l-blue-500 bg-white/5"
            >
        ...
        >
          ...
          <div className="text-center">
            <span className="text-[10px] font-black text-(--text-muted) uppercase tracking-[0.5em] mb-2 block">
              End of Academic Registry
            </span>
            <div className="flex items-center justify-center gap-2">
              <CheckCircle2 className="w-3 h-3 text-green-500" />
              <span className="text-[8px] font-mono text-green-500 font-bold uppercase tracking-widest">
                All Records Verified & Valid
              </span>
            </div>
          </div>
        </FadeIn>
